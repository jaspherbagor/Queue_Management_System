...
{ 
    ...
    {  
        ...
        elseif ($setting->display=='3b')
        {
            //counter wise display 2
            return view('backend.common.display.display3b', compact('setting'));
        }
    ...
    // { 
    //     $allTokens  = []; // all token
    //     $viewTokens = []; // all token from view
    //     $newTokens  = []; // new token
    //     $vTokens    = [];
    //     $cTokens    = [];
...
//             // Add each token to the list for session storage
//             $allTokens[] = $token->token;
//         }
//     }

//     // Store the tokens displayed in display3 in the session
//     session(['display3_tokens' => $allTokens]);
...
//     // Your existing logic to generate HTML and response...
//     $data['result'] = '';  // Add your HTML generation logic here
//     $data['new_token'] = [];  // Logic to generate new tokens for notification
//     $data['all_token'] = $allTokens;
//     $data['interval'] = 10000 * (count($newTokens) ? count($newTokens) : 1);
